...
RedeCiclavelLxkm <- function(Year){
  slideano =  ggplot()+
    ...
    #gravar cada imagem
    ggsave(slideano, filename=paste0("GIF/2022/",Year,"km.png"),
...
```{r}
library(magick)
imgs <- list.files("GIF/2022/", full.names = TRUE)
...
image_write(image = img_animated,
            path = "GIF/RedeCiclavelLisboa2022.gif")
