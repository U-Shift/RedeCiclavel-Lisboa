...
```
```{r include=FALSE}
CicloviasATUAL = readRDS("data/Ciclovias701.Rds") #remover quando estiverem novamente 701 ou mais no servidor
```
...
#saveRDS(CicloviasATUAL, "data/CicloviasNOVO072020.Rds") #data deste mês
```
...
```{r include=FALSE}
#guardar
saveRDS(CicloviasCORRECT, "CicloviasAnos/CicloviasCORRECTnovo.Rds")
...
Ciclovias2020T =Ciclovias2020T[!(Ciclovias2020T$IDunico=="18800_173" & Ciclovias2020T$AnoT>=2017),]
Ciclovias2020T =Ciclovias2020T[!(Ciclovias2020T$IDunico=="B0000031_186" & Ciclovias2020T$AnoT>=2017),]
